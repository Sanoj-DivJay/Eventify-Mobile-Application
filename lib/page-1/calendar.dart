          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 22 * fem, 4 * fem),
                child: Text(
                  'Event Calendar',
                  style: SafeGoogleFont(
                    'Poppins',
              ...
              Container(
                ...
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 12 * fem, 34 * fem),
                padding:
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 92, 10, 0),
                child: SizedBox(
                  height: 60,
                  width: double.infinity,
                  child: Row(

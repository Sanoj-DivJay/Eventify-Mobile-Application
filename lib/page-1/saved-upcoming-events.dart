        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(1.5*fem, 0*fem, 169.5*fem, 26.12*fem),
              width: double.infinity,
              child: Row(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 16*fem, 135.82*fem),
              padding: EdgeInsets.fromLTRB(6.12*fem, 5.01*fem, 59.97*fem, 5.01*fem),
              width: double.infinity,
              height: 45.06*fem,
              decoration: BoxDecoration (
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 24.47*fem, 0*fem),
                    width: 177.44*fem,
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(11.63*fem, 0*fem, 33.37*fem, 13*fem),
                            width: double.infinity,
                            decoration: BoxDecoration (
                              color: Color(0x7febf5fc),

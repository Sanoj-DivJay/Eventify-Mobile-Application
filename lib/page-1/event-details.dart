        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(17.5*fem, 0*fem, 143*fem, 16*fem),
              width: double.infinity,
              height: 22*fem,
              child: Row(
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    top: 0*fem,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 10.93*fem),
                      width: 361*fem,
                      height: 331.93*fem,
                      decoration: BoxDecoration (
                  ...
                  Positioned(
                    ...
                    top: 299*fem,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(7*fem, 41*fem, 7*fem, 0*fem),
                      width: 393*fem,
                      height: 470*fem,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 157*fem, 14.27*fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 16.11*fem, 0*fem),
                                  width: 33.9*fem,
                                  height: 32.23*fem,
                                  child: Image.asset(
                                ...
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 2.23*fem),
                                  child: RichText(
                                    text: TextSpan(
                                      style: SafeGoogleFont (
                                        'Poppins',
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 153*fem, 12.5*fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container(
                                  // time6bs (208:1272)
                                  margin: EdgeInsets.fromLTRB(0*fem, 1.5*fem, 15*fem, 0*fem),
                                  width: 37*fem,
                                  height: 36*fem,
                                  child: Image.asset(
                          ...
                          Container(
                            // about5Vj (208:1267)
                            margin: EdgeInsets.fromLTRB(5*fem, 0*fem, 12*fem, 1*fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text: ', the annual Sinhala and Tamil new year celebration of NSBM was held at 27th of April 2023 at NSBM Grounds.\n',
                                          style: SafeGoogleFont (
                                            'Poppins',
                                            fontSize: 15*ffem,
                                            fontWeight: FontWeight.w400,
                          ...
                          Container(
                            // contactmJ1 (208:1274)
                            margin: EdgeInsets.fromLTRB(3*fem, 0*fem, 148*fem, 37*fem),
                            width: double.infinity,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                          ...
                          Container(
                            // joiny2h (213:2422)
                            margin: EdgeInsets.fromLTRB(62*fem, 0*fem, 64*fem, 106.69*fem),
                            width: double.infinity,
                            decoration: BoxDecoration (
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(63.54*fem, 0*fem, 63.54*fem, 18.2*fem),
                            width: double.infinity,
                            height: 57*fem,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 68.71*fem, 0*fem),
                                  width: 91.61*fem,
                                  height: double.infinity,
                                  decoration: BoxDecoration (
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(63.54*fem, 0*fem, 63.54*fem, 0*fem),
                            padding: EdgeInsets.fromLTRB(68.96*fem, 54.11*fem, 67.96*fem, 0*fem),
                            width: double.infinity,
                            decoration: BoxDecoration (
                              color: Color(0xff087fae),
                              borderRadius: BorderRadius.circular(3*fem),

        ...
        child: Column(
          ...
          data: NavigationBarThemeData(
            ...
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 10.93 * fem),
                width: 361 * fem,
                height: 331.93 * fem,
                decoration: BoxDecoration(
            ...
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(7 * fem, 41 * fem, 7 * fem, 0 * fem),
                width: 393 * fem,
                height: 470 * fem,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                            ...
                            child: RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        ', the annual Sinhala and Tamil new year celebration of NSBM was held at 27th of April 2023 at NSBM Grounds.\n',
                                    style: SafeGoogleFont(
                                      'Poppins',
                                      fontSize: 15 * ffem,
                                      fontWeight: FontWeight.w400,
